...
export function addNotification(n: { title: string; detail: string }): NsNotification {
    const item: NsNotification = { id: Date.now() + Math.random(), time: new Date().toISOString(), ...n };
